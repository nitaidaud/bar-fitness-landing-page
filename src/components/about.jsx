        ...
        <section id="about" className="py-16 about-section bg-gray-800 fade-in animate__animated">
            <div className=" mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-center w-full lg:w-4/5 gap-14">
                    ...
                    <div className="text-balance flex flex-col items-start justify-center w-fit gap-4">
                        <div className="bg-gray-700 rounded-2xl p-6 shadow-lg max-w-2xl transform hover:scale-105 transition-transform duration-300">
